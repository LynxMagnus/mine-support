function setupAppInsights(win, doc, snipConfig) {
    ...
    if (aisdk.queue && aisdk.queue.length === 0) {
         aisdk.addTelemetryInitializer(function (evlp) {
          evlp.tags["ai.cloud.role"] = snipConfig.cfg.cloudRole;
         });        
         aisdk.trackPageView({});
    }
}

function startAppInsights(cfg) {
    setupAppInsights(window, document, {
        src: "https://az416426.vo.msecnd.net/scripts/b/ai.2.min.js", 
        // The SDK URL Source
        //name: "appInsights", 
        // Global SDK Instance name defaults to "appInsights" when not supplied
        //ld: 0, 
        ...
        //useXhr: 1, 
        // Use XHR instead of fetch to report failures (if available),
